...
/usr/bin/profiles -R -p com.machq.wifi-guest

#remove MacHQ Screen Saver profile
/bin/echo "********************************* Removing MacHQ screensaverprofile"
...
/usr/bin/profiles -R -p com.machq.5DDDA16E-4F16-4308-9989-B0A92241235C

#remove Skip Mojave Theme Selection profile
/bin/echo "********************************* Removing Skip Mojave Theme Selection profile"
/usr/bin/profiles -R -p com.machq.6BA50F28-F01C-4794-88EE-B32AFDAE8910
